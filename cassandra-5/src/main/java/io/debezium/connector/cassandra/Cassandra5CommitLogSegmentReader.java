...
public class Cassandra5CommitLogSegmentReader implements CommitLogSegmentReader {
    ...
    public Cassandra5CommitLogSegmentReader(CassandraConnectorContext context, CassandraStreamingMetrics metrics, CommitLogProcessorMetrics legacyMetrics) {
        this.commitLogReader = new CommitLogReader();
        this.commitLogReadHandler = new Cassandra5CommitLogReadHandlerImpl(context, metrics, legacyMetrics);
    }
