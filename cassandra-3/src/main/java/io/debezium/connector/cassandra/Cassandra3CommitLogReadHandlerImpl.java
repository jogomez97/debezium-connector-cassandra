...
import static io.debezium.connector.cassandra.Cassandra3CommitLogReadHandlerImpl.PartitionType.PARTITION_AND_CLUSTERING_KEY_ROW_DELETION;
import static io.debezium.connector.cassandra.Cassandra3CommitLogReadHandlerImpl.PartitionType.PARTITION_KEY_ROW_DELETION;
 ...
 */
public class Cassandra3CommitLogReadHandlerImpl implements CommitLogReadHandler {
    ...
    Cassandra3CommitLogReadHandlerImpl(CassandraConnectorContext context, CassandraStreamingMetrics metrics, CommitLogProcessorMetrics legacyMetrics) {
    ...
    private RangeData populateRangeData(ClusteringBound cb, String name, CFMetaData metaData) {
