...
public class Cassandra4CommitLogSegmentReader implements CommitLogSegmentReader {
    ...
    public Cassandra4CommitLogSegmentReader(CassandraConnectorContext context, CassandraStreamingMetrics metrics,
                                            CommitLogProcessorMetrics legacyMetrics) {
        this.commitLogReader = new CommitLogReader();
        this.commitLogReadHandler = new Cassandra4CommitLogReadHandlerImpl(context, metrics, legacyMetrics);
    }
